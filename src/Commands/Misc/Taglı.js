...
message.channel.send(embed.setDescription(`Sunucumuzda toplam ${message.guild.members.cache.filter(m => m.user.username.toLowerCase().includes(settings.sunucuTag)).size} kişide tag var.  \nSunucuda tag kontrolü yapılıyor.`))
